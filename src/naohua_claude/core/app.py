...
import naohua_claude
from naohua_claude.core.bus.commands import (
    AgentRunCommand,
    AgentRunResult,
...
from naohua_claude.core.bus.envelope import EventPushEnvelope
from naohua_claude.core.config import NaohuaConfig, get_config
...
from naohua_claude.core.permissions.storage import load_policy_file
from naohua_claude.core.runner import AgentRunner
from naohua_claude.core.runs import events_file, new_run_id
from naohua_claude.core.session import SessionManager, SessionStore
from naohua_claude.core.trace.record import TraceRecord
from naohua_claude.core.trace.writer import TraceWriter
from naohua_claude.core.transport.ipc_broadcaster import IpcEventBroadcaster
from naohua_claude.core.transport.socket_server import SocketServer, get_connection_writer
...
class CoreApp:
    def __init__(self) -> None:
        ...
        self._config: NaohuaConfig | None = None
    ...
    async def _ping_handler(self, params: dict[str, Any]) -> PongResult:
        ...
        return PongResult(
            server_version=naohua_claude.__version__,
    ...
    async def _replay_events(
        ...
        if not path.exists():
            for candidate in Path("~/.naohua/sessions").expanduser().glob(
    ...
    async def run(self) -> None:
        ...
        policy_file = Path("~/.naohua/policy.toml").expanduser()
        ...
        sessions_root = Path("~/.naohua/sessions").expanduser()
        ...
        logger.info("naohua-core %s listening addr=%s", naohua_claude.__version__, addr)
