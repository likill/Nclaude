...
from naohua_claude.core.bus.events import RunFinishedEvent, RunStartedEvent
from naohua_claude.core.compact.compactor import Compactor
from naohua_claude.core.config import NaohuaConfig
from naohua_claude.core.context import ExecutionContext
from naohua_claude.core.events.bus import EventBus, EventHandler
from naohua_claude.core.events.writer import EventWriter
from naohua_claude.core.llm.base import LLMProvider
from naohua_claude.core.llm.provider import AnthropicProvider
from naohua_claude.core.loop import AgentLoop
from naohua_claude.core.mcp.server import McpServerManager
from naohua_claude.core.memory.loader import load_context_file
from naohua_claude.core.permissions.manager import PermissionManager
from naohua_claude.core.runs import RUNS_DIR, new_run_id
from naohua_claude.core.session.model import Session
from naohua_claude.core.session.store import SessionStore
from naohua_claude.core.subagent.registry import BackgroundTaskRegistry
from naohua_claude.core.subagent.tool import AgentResultTool, SpawnAgentTool
from naohua_claude.core.task.manager import TaskManager
from naohua_claude.core.tools.builtin import (
    BashTool,
    ListDirTool,
    NoteSaveTool,
    ReadFileTool,
...
from naohua_claude.core.tools.registry import ToolRegistry
from naohua_claude.core.trace.provider import TracingProvider
from naohua_claude.core.trace.writer import TraceWriter
...
class AgentRunner:
    ...
    async def run_and_capture(
        ...
        *,
        ...
        global_ctx = load_context_file(Path("~/.naohua/context.md").expanduser())
        project_ctx = load_context_file(Path(".naohua/context.md"))
